...
function main()
    log.info("Starting Astra STREAM " .. astra.version)


    --------------------------------------- [Adapter to use] ---------------------------------------
    adapter_1 = dvb_tune({ -- TP Channels Movistar
        type = "S2", -- type
        adapter = 0, -- adapter TBS
        tp = "11422:H:30000" -- transponder signal
    })
    ...
    --------------------------------------- [Configure your newcamd] --------------------------------
    reader_1 = newcamd({ -- FENIX TV (1 Mes)
        name = "Newcamd # 1",
        host = "anydomain.cn",
        port = 11000,
        user = "luz94",
    ...
    reader_2 = newcamd({ -- FENIX TV (1 Mes)
        name = "Newcamd # 2",
        host = "anydomain.cn",
        port = 10005,
        user = "luz94555",
